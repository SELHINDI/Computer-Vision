...
class YOLO(nn.Module):
 ...
 # Conv5 + ReLU5 + MaxPool5
    ...
    # Conv8 + ReLU8
        ...
        # Conv9 + ReLU9
        modules.add_module('conv_9', nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1))
    ...
    # Fully connected layers
        modules.add_module('fc_1', nn.Linear(50176, 256))
        modules.add_module('fc_2', nn.Linear(256, 256))
        
        # Output layer
        # For num_boxes=2 and num_classes=1: 5*B + C = 5*2 + 1 = 11
        output_size = 7 * 7 * (5 * self.num_boxes + self.num_classes)
        modules.add_module('output', nn.Linear(256, output_size))
